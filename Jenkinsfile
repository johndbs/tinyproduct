pipeline{
    ...
    environment{
        ...
        */
        ...
        GIT_URL = 'https://github.com/johndbs/tinyproduct.git'
            ...
            steps{
                ...
                withCredentials([
                        ...
                        configFileProvider([configFile(fileId: "$env.MVN_SETTINGS_FILE_NAME", variable: 'MAVEN_SETTINGS_PATH')]) {
                            sh """
                            mvn -s $MAVEN_SETTINGS_PATH --batch-mode clean package -DskipTests
                            """
                        }
                    }
            }
        ...
        stage('Test'){
            steps{
                ...
                withCredentials([
                        ...
                        configFileProvider([configFile(fileId: "$env.MVN_SETTINGS_FILE_NAME", variable: 'MAVEN_SETTINGS_PATH')]) {
                            sh """
                            mvn -s $MAVEN_SETTINGS_PATH --batch-mode verify
                            """
                        }
                    }
